...
@section('content')
                            ...
                            <tbody>
                                @foreach ($shifts as $shift)
                                    <tr>
                                        ...
                                        <td>{{ $shift->name }}</td>
                                        <td>{{ $shift->start_time->format('H:i') }} - {{ $shift->end_time->format('H:i') }}
                                        </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <!-- Hidden field untuk kirim 0 saat checkbox tidak dicentang -->
                                    <input type="hidden" name="is_active" value="0">

                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                        value="1" {{ old('is_active', $shift->is_active ?? false) ? 'checked' : '' }}>
    ...
    <!-- Modal Create Shift -->
    <div class="modal fade" id="createShiftModal" tabindex="-1" aria-labelledby="createShiftModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
