...
use App\Repositories\CashhRepository;
use App\Services\CashhService;
use App\Exports\CashhExport;
use App\Imports\CashhImport;
use App\Http\Requests\Cashh\CreateCashhRequest;
use App\Http\Requests\Cashh\UpdateCashhRequest;
...
class CashController extends Controller
{
    ...
    public function __construct(CashhService $expend)
    {
        $this->expend = $expend;
    }
     ...
     */
    public function index(CashhRepository $expendRepo): View
    {
        $categories = $expendRepo->getCategories();

        return view('cashh.index', compact('categories'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CreateCashhRequest $request): JsonResponse
    {
...
*/        
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateCashhRequest $request, $id): JsonResponse
    {
    ...
    public function printall(Request $request)
    {
        ...
        $pdf = PDF::loadView('cashh.printall', compact('expends'));
    ...
    public function export(CashhExport $export)
    {
        return $export->download('pengeluaran.xlsx');
    }

    public function import(CashhImport $import, ImportStockRequest $request)
    {
