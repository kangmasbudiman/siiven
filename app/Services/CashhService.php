...
class CashhService extends Service {

    public function __construct(CashhRepository $expend)
    {
        $this->repo = $expend;
    }

    public function filter($dari = null, $sampai = null): Object
    {
        
        return $this->repo->filter($dari, $sampai);
    }
